        ...
        <div className="login">
            <div className="login-back">
                <div className="form">
                    ...
                    <p>Email</p>
                    <TextField onChange={(e) => setEmail(e.target.value)} id="email" label="Contoh: example@gmail.com" variant="outlined" style={{width: 370}} />
                    <p>Password</p>
                    <TextField onChange={(e) => setPassword(e.target.value)} id="password" label="*********" variant="outlined" style={{width: 370}} />
                    <br/>
